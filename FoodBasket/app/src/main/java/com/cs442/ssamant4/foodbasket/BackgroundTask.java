...
BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    {
        String reg_url = "http://192.168.1.145/webapp/register.php";
        String login_url = "http://192.168.1.145/webapp/login.php";
        String checkout_url = "http://192.168.1.145/webapp/Checkout.php";
    ...
    protected void onPostExecute(final String result) {
       /* if(result.equals("Registration Success..."))
        ...
        else if(result.trim().equalsIgnoreCase("User already exists, please select different user or password")
                || result.trim().equalsIgnoreCase("Registration Success")||
                result.trim().equalsIgnoreCase("Registration not Successfull")  ) {
           ...
           // alertDialog.setButton();
            alertDialog.setButton(android.support.v7.app.AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    if(result.trim().equalsIgnoreCase("User already exists, please select different user or password"))
                    {
