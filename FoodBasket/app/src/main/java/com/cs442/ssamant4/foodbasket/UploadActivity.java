...
public class UploadActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final String UPLOAD_URL = "http://192.168.1.145/PhotoUpload/upload.php";
    ...
    public void onClick(View v) {
        ...
        if(v == buttonUpload){
            if(etItemName.getText().toString().equals("")||etIngrediants.getText().toString().equals("")||etItemPrice.getText().toString().equals("")||etItemQuantity.getText().toString().equals("")){
